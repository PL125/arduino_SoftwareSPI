...
#define SBI_READ_WRITE	0x00
#define SBI_WRITE_ONLY	0x01
#define SBI_READ_ONLY		0x02

#define SBI_MODE0 0x00	//	   0	SCK L-H-L Clock on Leading Edge
#define SBI_MODE1 0x04	//	 100	SCK L-H-L	Clock on Trailing Edge
#define SBI_MODE2 0x08	//	1000	SCK	H-L-H	Clock on Leading Edge
#define SBI_MODE3 0x0C	//	1100	SCK H-L-H	Clock on Trailing Edge
...
#define SBI_SETTLE_TIME	0	// signal settle delay in uS to delay reading of incoming data bits
